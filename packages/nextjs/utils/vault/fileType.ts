...
const SIGNATURES: Signature[] = [
  ...
  { bytes: [0x52, 0x49, 0x46, 0x46], mime: "image/webp", extension: "webp", when: isWebP },
  { bytes: [0x25, 0x50, 0x44, 0x46], mime: "application/pdf", extension: "pdf" },

  { bytes: [0x52, 0x49, 0x46, 0x46], mime: "video/x-msvideo", extension: "avi", when: isAvi },
  { bytes: [0x66, 0x74, 0x79, 0x70], offset: 4, mime: "video/mp4", extension: "mp4" },
  { bytes: [0x1a, 0x45, 0xdf, 0xa3], mime: "video/webm", extension: "webm" },
  { bytes: [0x4f, 0x67, 0x67, 0x53], mime: "video/ogg", extension: "ogv" },
