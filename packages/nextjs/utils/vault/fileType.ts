/**
 * Detect MIME type and file extension from buffer magic bytes.
 * Used when recovering decrypted evidence so the download has the correct type and extension.
 */
...
const SIGNATURES: Signature[] = [
  ...
  // Videos (RIFF-based AVI must come after WebP)
...
/**
 * Returns MIME type and extension from the start of a buffer, or application/octet-stream and no extension.
 */
