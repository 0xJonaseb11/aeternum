        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-6xl w-full min-w-0">
          {connectedAddress && (
            <div className="flex flex-col sm:flex-row sm:items-end justify-between gap-4 mb-6 sm:mb-8">
              <p className="text-xs sm:text-sm text-base-content/60">
                Enter your key to find evidence, then verify or recover.
              </p>
          ...
          {!connectedAddress ? (
            <div className="rounded-2xl border-2 border-dashed border-base-300 bg-base-200/30 p-8 sm:p-12 text-center min-w-0">
              ...
              <p className="text-sm text-base-content/50">Use the same wallet you used when securing your evidence.</p>
            </div>
          ) : isWrongNetwork ? (
