      ...
      <Link
        ...
        className={`fixed bottom-2 right-4 z-50 group flex items-center gap-2 border px-3 py-1.5 rounded-full transition-all duration-500 shadow-xl scale-90 sm:scale-100 origin-right glass ${
          isDarkMode
            ...
            : "bg-secondary/40 text-primary border-primary/10 hover:bg-white/80 shadow-primary/5"
        }`}
      >
        <div className="flex flex-col items-end leading-none">
          <span className="text-[10px] opacity-60 transition-colors uppercase tracking-widest font-bold group-hover:text-primary">
            Built by
          </span>
        ...
        <div
          className={`p-1 rounded-full transition-colors ${
            isDarkMode ? "bg-primary/10" : "bg-primary/10 group-hover:bg-primary/20"
          }`}
        >
          <svg
            viewBox="0 0 24 24"
            className={`h-3 w-3 transition-colors ${isDarkMode ? "fill-primary" : "fill-primary"}`}
