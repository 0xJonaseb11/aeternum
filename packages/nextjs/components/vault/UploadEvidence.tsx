...
import { CloudArrowUpIcon, DocumentIcon, XMarkIcon, ShieldCheckIcon } from "@heroicons/react/24/outline";
            ...
            <div className="card-body p-8">
                <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                        ...
                        <p className="text-xs text-base-content/50 mt-1 uppercase tracking-widest font-bold">Secure Local Encryption</p>
                    </div>
                </div>
